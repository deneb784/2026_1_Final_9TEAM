...
void print_statistic()
{
    ...
    double flow_goodput_mbps;    /* per-flow goodput (Mbps) */
    double goodput_mbps; /* total goodput (Mbps) */
    unsigned int i = 0;
    FILE *fd = NULL;
